<h1 align="center"> Backend Developer in Java
...
## Spring Framework
- [初識Spring Framework](初識Spring%20Framework.md)
- Spring Boot
- Spring Cloud
## Mybatis
## Hibernate

<h1 id = "Algo">Common Algorithm</h1>
...
<h1 id = "SearchEngine">Search Engine</h1>

- ElasticSearch
- Lucene
- Solr

<h1 id = "DesignPattern">Design Pattern and Development Principles</h1>
...
<h1 id = "SoftwareArchitecture">Software Architecture</h1>
